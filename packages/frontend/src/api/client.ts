...
export const createPreset = (data: { name: string; description?: string }) =>
...
// Generation
export const startGeneration = (data: { presetId: number; designId: number }) =>
...
export const updateSettings = (data: { printfulToken?: string; publicUrl?: string }) =>
